import { mobileAll, mobileCreate, mobileUpdate, mobileDelete, mobileSearch } from '../services/mobile';
...
export default {
    ...
    reducers: {
        ...
        updateSuccess(state, { payload }){
            const newList = state.list.map(mobile => mobile.id == payload.id ? {...mobile, ...payload} : mobile);
