...
export default {
    ...
    effects: {
        *allByCompanyID({ payload }, { select, call, put }) {
            ...
            const response = yield call(journeyDetailAllByCompanyID, {
                ...payload,
                limit: setting.item,
            ...
            if (response.success) {
                ...
                Modal.error({
                    title: 'Error al consultar el journeyDetailo',
        ...
        *update({ payload }, { call, put }) {
            ...
            if (response.success) {
                ...
                Modal.error({
                    title: 'Error al actualizar el journeyDetailo',
                    content: response.message,
                });
            }
        },
