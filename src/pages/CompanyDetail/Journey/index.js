...
class Journey extends Component {
    ...
    render() {
        ...
        const { list, total, current, searchText, currentItem } = journey;
        ...
        return (
            <Fragment>
                ...
                <div className={styles.header}>
                    ...
                    <Button icon="reload" onClick={() => this.onQueryAllByCompanyID()} />
                    <ModalForm />
                </div>
                <Map />
                <Spacing />
                <Button type="primary" icon="cloud-upload" onClick={() => onShowModalUpload()}>
                    Upload
                </Button>
                <UploadModal />
            </Fragment>
