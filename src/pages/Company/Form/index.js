                    ...
                    <Form layout="horizontal">
                        ...
                        <Form.Item hasFeedback {...formItemLayout} label="RUC">
                            {getFieldDecorator('ruc', {
                                ...
                                rules: [{ required: true, message: '¡Por favor ingrese un RUC!' }],
...
class ModalForm extends Component {
    ...
    render() {
        ...
        const { currentItem, modalType, modalVisible } = company;
        ...
        return (
            <AddForm {...companyModal} wrappedComponentRef={formRef => (this.formRef = formRef)} />
        );
    }
}
