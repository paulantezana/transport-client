                    ...
                    <Form layout="horizontal">
                        ...
                        <Form.Item {...formItemLayout} label="Clave">
                            {getFieldDecorator('key', {
                                ...
                                <Input
                                    addonAfter={<Icon type="lock" onClick={this.generateKey} />}
                                    placeholder="Clave"
                                />
                            )}
                        </Form.Item>
...
class ModalForm extends Component {
    ...
    render() {
        ...
        const { currentItem, modalType, modalVisible } = mobile;
        ...
        return (
            <AddForm {...mobileModal} wrappedComponentRef={formRef => (this.formRef = formRef)} />
        );
    }
}
