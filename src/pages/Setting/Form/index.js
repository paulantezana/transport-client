        ...
        render() {
            ...
            return (
                <Form onSubmit={this.handleSubmit}>
                    <Form.Item hasFeedback label="RUC" help="RUC de la empresa">
                        {getFieldDecorator('identification', {
                            ...
                            rules: [
                                {
                                    required: true,
                                    message: '¡Por favor ingrese su identification!',
                                },
                                {
                                    pattern: /^[0-9]{11}$/,
                                    message: '¡Ingrese una identification válido!',
                                },
                            ],
                        })(<Input />)}
                    </Form.Item>
                    ...
                    <Form.Item hasFeedback label="Ciudad" help="Ubicacion geografica de la empresa">
                        {getFieldDecorator('city', {
                            initialValue: setting.city,
                        })(<Input />)}
                    </Form.Item>
                    <Form.Item
                        label="Item"
                        help="Número de items a mostrar en cada página de una tabla"
                    >
                            ...
                            rules: [
                                {
                                    ...
                                    message: '¡Solo se permiten valores numéricos de 3 a 255!',
                                },
                    ...
                    <Form.Item
                        label="Cotizaciones"
                        help="Número maximo cotizaciones que se pueden realizar en un requerimiento"
                    >
                        {getFieldDecorator('quotations', {
                            initialValue: setting.quotations,
                            rules: [
                                {
                                    pattern: /^([1-9]|1[0-5])$/,
                                    message: '¡Solo se permiten valores numéricos de 1 a 15!',
                                },
                                { required: true, message: '¡Por favor ingrese un número!' },
                            ],
                        })(<InputNumber min={1} max={15} step={1} />)}
                    </Form.Item>
                    <Form.Item>
