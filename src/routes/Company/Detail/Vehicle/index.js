...
class Vehicle extends Component{
    ...
    render(){
        const { dispatch, setting, vehicle, loadingPaginateByCompanyID, loadingUpdate} = this.props;
        ...
        return (
            <Fragment>
                <div className={styles.header}>
                    ...
                    <Button icon="reload" onClick={()=>this.onQueryPaginateByCompanyID()}></Button>
                    <Search placeholder="Buscar vehicleo" value={searchText} onChange={e=>onSearchText(e.target.value)} onSearch={value => this.onQueryPaginateByCompanyID()} style={{ width: 200 }}/>
                    <ModalForm/>
                </div>
